...
// Hack: c++ style constexpr definition instead of a preprocessor macro
#undef cudaSharedMemConfig hipSharedMemConfig
#undef CUresult hipError_t
#undef cudaError_t hipError_t
#undef cudaSuccess hipSuccess
#undef cudaStream_t hipStream_t
#undef cudaGetErrorString hipGetErrorString
#undef cuFloatComplex hipFloatComplex
#undef make_cuFloatComplex make_hipFloatComplex
#undef cuDoubleComplex hipDoubleComplex
#undef make_cuDoubleComplex make_hipDoubleComplex
#undef cudaPeekAtLastError hipPeekAtLastError
#undef cudaGetLastError hipGetLastError
#undef cudaDeviceSynchronize hipDeviceSynchronize
#undef cudaEvent_t hipEvent_t
#undef cudaEventCreate hipEventCreate
#undef cudaEventDestroy hipEventDestroy
#undef cudaEventRecord hipEventRecord
#undef cudaEventSynchronize hipEventSynchronize
#undef cudaEventElapsedTime hipEventElapsedTime
#undef cudaStreamSynchronize hipStreamSynchronize
#undef cudaStreamCreate hipStreamCreate
#undef cudaStreamCreateWithPriority hipStreamCreateWithPriority
#undef cudaStreamDestroy hipStreamDestroy
#undef cudaMemcpyKind hipMemcpyKind
#undef cudaMemcpyHostToDevice hipMemcpyHostToDevice
#undef cudaMemcpyDeviceToHost hipMemcpyDeviceToHost
#undef cudaMemcpyDeviceToDevice hipMemcpyDeviceToDevice
#undef cudaMemcpyHostToHost hipMemcpyHostToHost
#undef cudaSetDevice hipSetDevice
#undef cudaMemcpy hipMemcpy
#undef cudaMemcpyAsync hipMemcpyAsync
#undef cudaMemcpyToSymbol hipMemcpyToSymbol
#undef cudaMemcpyFromSymbol hipMemcpyFromSymbol
#undef cudaMemcpyToSymbolAsync hipMemcpyToSymbolAsync
#undef cudaMemcpyFromSymbolAsync hipMemcpyFromSymbolAsync
#undef cudaMemcpy2DAsync hipMemcpy2DAsync
#undef cudaMemcpyDefault hipMemcpyDefault
#undef cudaMemset hipMemset
#undef cudaMalloc hipMalloc
#undef cudaMallocHost hipHostMalloc
#undef cudaFreeHost hipHostFree
#undef cudaFree hipFree
#undef cudaGetDevice hipGetDevice
#undef cudaDevAttrCooperativeLaunch hipDeviceAttributeCooperativeLaunch 
#undef cudaDevAttrClockRate hipDeviceAttributeClockRate
#undef cudaDevAttrMemoryClockRate hipDeviceAttributeMemoryClockRate
#undef cudaDevAttrSingleToDoublePrecisionPerfRatio hipDeviceAttributeSingleToDoublePrecisionPerfRatio 
#undef cudaDevAttrComputeMode hipDeviceAttributeComputeMode
#undef cudaDeviceAttr hipDeviceAttribute_t 
#undef cudaDeviceProp hipDeviceProp_t
#undef cudaGetDeviceCount hipGetDeviceCount
#undef cudaLaunchCooperativeKernel hipLaunchCooperativeKernel
#undef cudaDeviceGetPCIBusId hipDeviceGetPCIBusId
#undef cudaMemGetInfo hipMemGetInfo
#undef cudaStreamNonBlocking hipStreamNonBlocking
#undef cudaMemcpyPeerAsync hipMemcpyPeerAsync
#undef cudaGetDeviceProperties hipGetDeviceProperties
#undef cudaDeviceGetAttribute hipDeviceGetAttribute
#undef cudaStreamQuery hipStreamQuery
#undef cudaErrorNotReady hipErrorNotReady
#undef cudaDeviceGetStreamPriorityRange hipDeviceGetStreamPriorityRange
#undef cudaProfilerStart roctracer_start
#undef cudaProfilerStop roctracer_stop
#undef cudaDeviceSetSharedMemConfig hipDeviceSetSharedMemConfig
#undef cudaFuncSetSharedMemConfig hipFuncSetSharedMemConfig
#undef cudaSharedMemBankSizeEightByte hipSharedMemBankSizeEightByte
#undef cudaSharedMemBankSizeFourByte hipSharedMemBankSizeFourByte
#undef cudaDeviceSetCacheConfig hipDeviceSetCacheConfig
#undef cudaFuncCachePreferShared hipFuncCachePreferShared
#undef cudaFuncCachePreferL1 hipFuncCachePreferL1
#undef cudaErrorInvalidConfiguration hipErrorInvalidConfiguration
#undef cudaErrorLaunchOutOfResources hipErrorLaunchOutOfResources
#undef cudaGetErrorName hipGetErrorName
#undef cudaMemGetInfo   hipMemGetInfo
#undef cudaOccupancyMaxActiveBlocksPerMultiprocessor hipOccupancyMaxActiveBlocksPerMultiprocessor
#undef curandStateXORWOW_t hiprandStateXORWOW_t
#undef curandStateMRG32k3a_t hiprandStateMRG32k3a_t
#undef curandState hiprandState
#undef curand_init hiprand_init
#undef curand_uniform hiprand_uniform
#undef curand_uniform_double hiprand_uniform_double
#undef cudaDriverGetVersion  hipDriverGetVersion
#undef cudaRuntimeGetVersion hipRuntimeGetVersion
